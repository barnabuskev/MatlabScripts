...
%%% BEGIN ENTRIES %%%
     'P:\Matlab;', ...
     'P:\Matlab\Apps;', ...
     'P:\Matlab\Apps\EMGtimer;', ...
     'P:\Matlab\ColletteData;', ...
     'P:\Matlab\ColletteData\Experiment Colette;', ...
     'P:\Matlab\ColletteData\Experiment Colette\Experiment;', ...
     'P:\Matlab\EMGsession;', ...
     'P:\Matlab\Hania;', ...
     'P:\Matlab\Hania\Experiment;', ...
     'P:\Matlab\Hania\Experiment\Aimee Photo Back Up;', ...
     'P:\Matlab\Hania\Experiment\photos;', ...
     'P:\Matlab\Hania\Final Pilot;', ...
     'P:\Matlab\Hania\Pilot;', ...
     'P:\Matlab\MatlabSonyLptp;', ...
     'P:\Matlab\ProjectEmo;', ...
     'P:\Matlab\ProjectZeus;', ...
     'P:\Matlab\Spirodata;', ...
     'P:\Matlab\Spirodata\Test;', ...
     'P:\Matlab\classes;', ...
     'P:\Matlab\data;', ...
     'P:\Matlab\utilities;', ...
